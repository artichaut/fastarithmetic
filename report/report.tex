...
@benchmark macro available in the BenchmarkTools package. In the following, $m$
will be the degree of the polynomial $P$, which is a precomputed irreducible
polynomial obtained by taking random polynomials of degree $m$ in
$\mathbb{F}_{p}[X]$. In the arrays, the speed of
